...
class CalculatorTests {
	...
	public void test8() throws Exception {
		...
		WoodScrew toAdd = new WoodScrew(2.0, "#8-13", "Steel", "ACQ 1000 Hour", "Flat", "Philips", "Type 17", 44.10,
				750);
		assertNotNull(toAdd);
		db.add(toAdd);
	}
	...
	public void test15() throws Exception {
		// thread, material, finish, price/unit, unit size
		assertThrows(IllegalFastener.class,
				() -> new WingNut("1/4-20", "Stainless Steel", "Black Phosphate", 0.5528, 1));
	}
	...
	public void test18() throws Exception {
		// length, thread, material, finish, price/unit, unit size
		assertThrows(IllegalFastener.class,
				() -> new CarriageBolt(0.05, "1/4-20", "Stainless Steel", "Plain", 18.825, 50));
	}
	...
	public void test20() throws Exception {
		// length, thread, material, finish, head, drive, point, price/unit, unit size
		assertThrows(IllegalFastener.class,
				() -> new WoodScrew(2.0, "#8-13", "Steel", "ACQ 1000 Hour", "Flat", "Philips", "Blunt", 44.10, 750));
	}
	...
	public void test21() throws Exception {
		// length, thread, material, finish, head, drive, point, price/unit, unit size
		assertThrows(IllegalFastener.class,
				() -> new WoodScrew(25.0, "#8-15", "Steel", "Zinc", "Flat", "Square", "Sharp", 8.84, 100));
	}
	...
	public void test22() throws Exception {
		// length, thread, material, finish, head, drive, point, price/unit, unit size
		assertThrows(IllegalFastener.class,
				() -> new WoodScrew(3.0, "#10-13", "Aluminium", "Zinc", "Flat", "Square", "Sharp", 24.63, 100));
	}

	@Test
	public void extraTest1() throws Exception {
		// length, thread, material, finish, head, drive, point, price/unit, unit size
		WoodScrew toAdd = new WoodScrew(2.0, "#8-13", "Steel", "Lubricated", "Flat", "Philips", "Type 17", 44.10, 750);
		assertNotNull(toAdd);
		db.add(toAdd);
	}
	...
	public void extraTest2() throws Exception {
		// length, thread, material, finish, head, drive, point, price/unit, unit size
		assertThrows(IllegalFastener.class,
				() -> new WoodScrew(2.0, "#8-13", "Brass", "ACQ 1000 Hour", "Flat", "Philips", "Type 17", 44.10, 750));
	}

	@Test
	public void extraTest3() throws Exception {
		// thread, material, finish, price/unit, unit size
		assertThrows(IllegalFastener.class, () -> new WingNut("5/16-18", "Steel", "ACQ 1000 Hour", 18.225, 50));
	...
	public void extraTest4() throws Exception {
		// thread, material, finish, price/unit, unit size
		assertThrows(IllegalFastener.class,
				() -> new WoodScrew(5.25, "#8-13", "Brass", "Plain", "Flat", "Philips", "Type 17", -10, 5));

	}

	@Test
	public void extraTest5() throws Exception {
		// thread, material, finish, price/unit, unit size
		assertThrows(IllegalFastener.class,
				() -> new WoodScrew(5.25, "#8-13", "Brass", "Plain", "Flat", "Philips", "Type 17", 44.1, 7));
