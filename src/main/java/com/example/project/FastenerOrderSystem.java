...
public class FastenerOrderSystem {
    ...
    // The order system just allows the user to choose a faster from a sub-list of
    // those
    // available, then asks for how many of these fasteners the user would like to
    // order.
